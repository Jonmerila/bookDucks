...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    books: Attribute.Relation<
      ...
      'api::book.book'
    >;
    read_list: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::read-list.read-list'
    >;
    rating_list: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToOne',
      'api::rating-list.rating-list'
    >;
    givenRatings: Attribute.JSON;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    bookCover: Attribute.Media & Attribute.Required;
    averageGrade: Attribute.Decimal &
      Attribute.SetMinMax<
        {
          min: 0;
          max: 10;
...
export interface ApiRatingListRatingList extends Schema.CollectionType {
...
export interface ApiThemeTheme extends Schema.SingleType {
  ...
  attributes: {
    theme: Attribute.JSON & Attribute.Required;
    selectedTheme: Attribute.Enumeration<
      ['darkmode', 'lightmode', 'red-theme']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::rating-list.rating-list': ApiRatingListRatingList;
      'api::read-list.read-list': ApiReadListReadList;
